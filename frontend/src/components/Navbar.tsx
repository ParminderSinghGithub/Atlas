            ...
            {isAuthenticated ? (
              <div className="flex items-center gap-4">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm text-gray-300">{userDisplay.prefix}</span>
                </div>
                <button
                  onClick={logout}
              ...
              <div className="flex gap-3">
                <Link
                  to="/login"
                  className="bg-blue-600 hover:bg-blue-700 px-5 py-2 rounded-lg transition-colors font-medium"
                >
                  Login
                </Link>
                <Link
                  to="/register"
                  className="bg-purple-600 hover:bg-purple-700 px-5 py-2 rounded-lg transition-colors font-medium"
                >
                  Register
                </Link>
              </div>
